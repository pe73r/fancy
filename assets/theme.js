...
theme.headerNav = (function() {
  ...
  function accessibleDropdowns() {
    ...
    $(selectors.navLinks).on('focusin mouseover' + config.namespace, function() {
      ...
      if ($parentItem.hasClass(selectors.hasDropdownClass)) {
        $parentItem.addClass(selectors.dropdownActive);
        hasActiveDropdown = true;
      }

      if (!closeOnClickActive) {
        closeOnClickActive = true;
        $('body').on('click' + config.namespace, function() {
          closeSecondLevelDropdown();
          closeThirdLevelDropdown();

          $(this).off(config.namespace);
    ...
    $(selectors.navDropdownLinks).on('focusin' + config.namespace, function() {
      ...
      var $parentItem = $(this).parent();
      if ($parentItem.hasClass(selectors.hasSubDropdownClass)) {
        $parentItem.addClass(selectors.dropdownActive);
    ...
    function closeSecondLevelDropdown() {
      $(selectors.navItems).removeClass(selectors.dropdownActive);
    }

    function closeThirdLevelDropdown() {
      $(selectors.navDropdownLinks).parent().removeClass(selectors.dropdownActive);
    }
  }
  ...
  Product.prototype = $.extend({}, Product.prototype, {
    ...
    updateInventory: function(evt) {
      ...
      if (!showInventory) {
        ...
        $inventoryLabel
          .removeClass('hide')
          .text(theme.strings.stockLabel.replace('[count]', variant.inventory_quantity));
      }
    },
